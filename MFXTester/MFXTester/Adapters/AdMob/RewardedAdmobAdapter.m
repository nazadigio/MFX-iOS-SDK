...
+ (GADVersionNumber)version {
    return [RewardedAdmobAdapter GADVersionNumberFromString:[MobFoxSDK sdkVersion]];// TODO: Manage a separate version for the adapter?
}

/// Returns the ad SDK version.
+ (GADVersionNumber)adSDKVersion {
    return [RewardedAdmobAdapter GADVersionNumberFromString:[MobFoxSDK sdkVersion]];
}
